...
from khanhSolana.khanhSolanaMeathod import *
from nacl.public import PrivateKey as NaclPrivateKey
import base64
from nacl.signing import SigningKey

class KhanhSolanaRPC:
...
class KhanhSolanaClient(KhanhSolanaRPC):
    def __init__(self, program_id: str, localhost=False, namenet="devnet"):
        super().__init__(program_id, localhost, namenet)

    def make_key_pair(self, secret_key: str, seed = "khanhNFT"):
    ...
    def inner_BaseStoreDataClass(object):
        ...
        class BaseStoreDataClass(BaseStruct):
            def __init__(self, **kwargs):
                ...
                depth=KhanhUint8(_depth)
                pubkeys=KhanhArrayStruct(_max_len_pubkeys, lambda: KhanhPublicKey())
                status=KhanhArrayStruct(_max_len_pubkeys, lambda: KhanhUint8(0))
